...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-full bg-white p-1 text-primary shadow-inner',
      className
    )}
    {...props}
  />
...
// className="h-5/6 relative overflow-scroll"
